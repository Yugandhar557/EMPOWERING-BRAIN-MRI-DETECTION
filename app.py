...
def model_predict1(image_path,model):
    ...
    if result == 1:
        return "THE PATIENT HAVE BEEN SUFFER FROM BRAIN TUMOR","after.html"        
    elif result == 0:
        return "THE PATIENT DON'T SUFFER FROM BRAIN TUMOR","after.html"
...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "THE PATIENT HAVE BEEN SUFFER FROM BRAIN GLIOMA TUMOR","after1.html"        
    elif result == 1:
        return "THE PATIENT HAVE BEEN SUFFER FROM BRAIN MENINGIOMA TUMOR","after1.html"        
    elif result == 2:
        return "THE PATIENT DON'T SUFFER FROM BRAIN TUMOR","after1.html"
    elif result == 3:
        return "THE PATIENT HAVE BEEN SUFFER FROM BRAIN PITUITARY TUMOR","after1.html"        
